<template>
    <div class="register">
        <div class="top">
            ...
            <div class="level">
                <svg t="1740120625592" class="icon" viewBox="0 0 1024 1024" version="1.1"
